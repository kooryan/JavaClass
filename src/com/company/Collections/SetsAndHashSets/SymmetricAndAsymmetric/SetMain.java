...
public class SetMain {
    public static void main(String[] args) {
        ...
        for (String s : words) {
            System.out.println(s); // not guaranteed to be in a particular order.
        }
        ...
        // getting the asymmetric difference
        ...
        if(nature.containsAll(divine)) {
            System.out.println("Divine is a subset of nature"); // divine is not a subset of nature
        }
